...
---
### Long Term Madness
 [Home](dm-operations-center) > [Life & Death](life-and-death) > [Madness](madness)  > Long Term {.small-text}
...
| 11-20 | **Hallucinations**. [Disadvantage](advantage-disadvantage) on ability checks. |
| 21-30 | **Paranoia**. [Disadvantage](advantage-disadvantage) on wisdom and charisma checks.  |
...
| 66-75 | **Tremors** or **Tics**. [Disadvantage](advantage-disadvantage) on STR & DEX related [attacks](attack), [checks](ability-checks), and [saves](saving-throw). |
| 76-85 | **Amnesia**. Know who they are, but don't recognize people or anything before the madness took effect.   |
| 86-90 | **Confusion**. [Confused](/spell/confusion) for 1 min if they fail a DC15 WIS [save](saving-throw) after taking damage. |
| 91-95 | **Speechless**. Loses the ability to speak and cast spells with a [somatic component](components). |
| 96-00  | **Unconcious**. Falls unconscious and jostling or damage will notwake them.  |
{.gray .small-text}
