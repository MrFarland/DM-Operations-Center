...
- 0 HP = [unconcious](unconcious) and ([stablized](stabliized) or [dying](death-saving-throw))
{.square}

**Level Up**<br/>
When a character levels up, they can choose to roll their [hit die](hit-die) or take the average for their die.
